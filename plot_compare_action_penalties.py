...
smoothness = [
    ...
    # 0.0041,  # Act. Rate -0.8
    0.0043,  # Act. Magnitude -0.8
    # 0.0078,  # Act. Magnitude -0.05
    # 0.0155,  # Act. Magnitude -0.01
    0.0050,  # Act. Rate/Magn -0.1/-0.01
...
for i, name in enumerate(config_names):
    plt.annotate(name, (mean_mae[i], avg_success[i]), textcoords="offset points", xytext=(5,5), ha='left', fontsize=8)
...
# Annotate points
for i, name in enumerate(config_names):
    plt.annotate(name, (smoothness[i], avg_success[i]), textcoords="offset points", xytext=(5,5), ha='left', fontsize=8)
