...
def main():
    ...
    run = wandb.init(
        project="impedance_ctrl_sb3_ppo_ur5e_reach_0_05_pose_without_gripper",
        config=config,
    ...
    # Load env cfg
    task = "UR5e-Impedance-Ctrl" # "UR5e-Domain-Rand-Reach-Pose-IK" # "UR5e-Reach-Pose-IK" # "UR5e-Lift-Cube"
