...
def main():
    ...
    run = wandb.init(
        project="rel_ik_sb3_ppo_ur5e_reach_0_05_pose_without_gripper_parameter_optimization", #"impedance_ctrl_sb3_ppo_ur5e_reach_0_05_pose_without_gripper",
        config=config,
    ...
    # Load env cfg
    task = "UR5e-Reach-Pose-IK" # "UR5e-Impedance-Ctrl" # "UR5e-Domain-Rand-Reach-Pose-IK" # "UR5e-Reach-Pose-IK" # "UR5e-Lift-Cube"
    ...
    if isinstance(env, VecNormalize):
        vecnorm_path = os.path.join("models", run.id, "vecnormalize.pkl")
