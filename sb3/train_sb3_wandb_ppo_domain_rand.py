...
def main():
    ...
    with open("./config_sb3_ppo_domain_rand.yaml") as file:
        config = yaml.load(file, Loader=yaml.FullLoader)

    run = wandb.init(
        project="rel_ik_sb3_ppo_ur5e_reach_0_05_pose_hand_e_domain_rand_v2",
        config=config,
    ...
    # Load env cfg
    task = "UR5e-Domain-Rand-Reach-Pose-IK" # "UR5e-Reach-Pose-IK" # "UR5e-Lift-Cube"
