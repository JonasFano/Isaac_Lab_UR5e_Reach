...
from taskparameters_ur3e import TaskParams

@configclass
class RelIK_UR3e_ReachEnvCfg(reach_env_cfg_pose_ur3e.UR3e_ReachEnvCfg):
...
@configclass
class RelIK_UR3e_ReachEnvCfg_PLAY(RelIK_UR3e_ReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
