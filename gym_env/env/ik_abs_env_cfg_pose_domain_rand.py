...
@configclass
class AbsIK_UR5e_Domain_Rand_ReachEnvCfg(reach_env_cfg_pose_domain_rand.UR5e_Domain_Rand_ReachEnvCfg):
...
@configclass
class AbsIK_UR5e_Domain_Rand_ReachEnvCfg_PLAY(AbsIK_UR5e_Domain_Rand_ReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
